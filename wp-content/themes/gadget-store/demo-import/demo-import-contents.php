	...
	public function wizard_page() { 
		...
		<div class="wrap">
			...
			<div class="card whizzie-wrap">
				...
				<div class="demo_content_image">
					...
					<div class="demo_image">
						<div class="demo_image buttons">
							<a href="<?php echo esc_url( GADGET_STORE_PRO_THEME_URL ); ?>" class="button button-primary bundle" target="_blank"><?php echo esc_html__( 'Get Pro Theme', 'gadget-store' ); ?></a>
							<a href="<?php echo esc_url( GADGET_STORE_DEMO_THEME_URL ); ?>" class="button button-primary bundle pro" target="_blank"><?php echo esc_html__( 'Live Demo', 'gadget-store' ); ?></a>
				...
				<div class="bundle-getstart-div">
					<div class="bundle-getstart-img-div">
						<a target="_blank" href="<?php echo esc_url( GADGET_STORE_THEME_BUNDLE_URL ); ?>">
							<img class="bundle-imgs" src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/bundle_image.png' ); ?>" alt="<?php echo esc_attr( $gadget_store_theme_title ); ?>" />
						</a>
					</div>
					<div class="bundle-getstart-lifetime-div">
						<h2><?php echo esc_html__( 'WordPress Theme Bundle | 50+ Premium Designs for Every Need', 'gadget-store' ); ?></h2>
						<a class="button button-primary" target="_blank" href="<?php echo esc_url( GADGET_STORE_THEME_BUNDLE_URL ); ?>">
							<?php echo esc_html__( 'Get All 50+ Themes @ $79', 'gadget-store' ); ?>
						</a>
					</div>
				</div>
			...
			<div class="about-wrappp-main-div">
				<h1 class="title" style="margin:0;"><?php esc_html_e( 'More Information', 'gadget-store' ); ?></h1>
				<div class="about-wrappp">
					<div class="about-wrappp-boxes-div">
						<div class="about_wrappp_demo_content">
							<p class="about-description" style="margin-bottom:0;" ><?php esc_html_e( 'Quick Links:', 'gadget-store' ); ?></p>
							<div class="feature-section two-col">
								<div class="card buy-noww" style="background:linear-gradient(to bottom,#0189f0,#024985) !important;">
									<h2 style="color:#fff;" class="title"><?php esc_html_e( 'Upgrade To Pro', 'gadget-store' ); ?></h2>
									<p style="color:#fff;"><?php esc_html_e( 'Take a step towards excellence, try our premium theme. Use Code', 'gadget-store' ) ?><span class="usecode"><?php esc_html_e('" STEPRO10 "', 'gadget-store'); ?></span></p>
									<p><a  style="background: red !important;" href="<?php echo esc_url( GADGET_STORE_PRO_THEME_URL ); ?>" class="button button-primary" target="_blank"><?php esc_html_e( 'Upgrade Pro', 'gadget-store' ); ?></a></p>
								</div>
								...
								<div class="card">
									...
									<p><a href="<?php echo esc_url( GADGET_STORE_FREE_DOCS_THEME_URL ); ?>" class="button button-primary" target="_blank"><?php esc_html_e( 'Lite Documentation', 'gadget-store' ); ?></a></p>
								</div>

								<div class="card">
									<h2 class="title"><?php esc_html_e( 'Theme Info', 'gadget-store' ); ?></h2>
									<p><?php esc_html_e( 'Know more about Gadget Store.', 'gadget-store' ) ?></p>
									<p><a href="<?php echo esc_url( GADGET_STORE_FREE_THEME_URL ); ?>" class="button button-primary" target="_blank"><?php esc_html_e( 'Theme Info', 'gadget-store' ); ?></a></p>
								</div>
								...
								<div class="card">
									...
									<p><a href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>" class="button button-primary" target="_blank"><?php esc_html_e( 'Customize', 'gadget-store' ); ?></a></p>
								</div>
								...
								<div class="card">
									...
									<p><a href="<?php echo esc_url( GADGET_STORE_SUPPORT_THEME_URL ); ?>" class="button button-primary" target="_blank"><?php esc_html_e( 'Support Forum', 'gadget-store' ); ?></a></p>
								</div>
								...
								<div class="card">
									...
									<p><a href="<?php echo esc_url( GADGET_STORE_RATE_THEME_URL ); ?>" class="button button-primary" target="_blank"><?php esc_html_e( 'Rate Us', 'gadget-store' ); ?></a></p>
								</div>		
							</div>
							...
							<table>
								...
								<tr class="odd" scope="row">
									...
									<tr class="odd" scope="row">
										...
										<td class="feature feature--empty"></td>
										<td headers="comp-2" class="td-btn-2"><a class="button button-primary bundle" href="<?php echo esc_url(GADGET_STORE_PRO_THEME_URL);?>" target="_blank"><?php esc_html_e( 'Go for Premium', 'gadget-store' ); ?></a></td>
									</tr>
								</tbody>
							</table>
						</div>
