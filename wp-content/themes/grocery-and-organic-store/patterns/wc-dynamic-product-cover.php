 ...
 * Slug: grocery-and-organic-store/wc-dynamic-product-cover
			...
			<div class="wp-block-column" style="flex-basis:25%">
				...
				<div class="wp-block-group has-border-color has-heading-color has-text-color has-link-color"
					...
					<h2 class="wp-block-heading has-heading-color has-text-color has-link-color has-medium-font-size"
						...
						<?php esc_html_e( 'Top Categories', 'grocery-and-organic-store' ); ?></h2>
					<!-- /wp:heading -->
					...
					<div class="wp-block-group has-primary-color has-text-color" style="font-style:normal;font-weight:500">
						<!-- wp:woocommerce/product-categories {"hasImage":true,"isHierarchical":false,"className":"is-style-grocery-and-organic-store-wc-categories-primary","style":{"typography":{"lineHeight":"1.2","fontSize":"14px"},"layout":{"selfStretch":"fit","flexSize":null},"elements":{"link":{":hover":{"color":{"text":"var:preset|color|primary"}}}}}} /-->
					</div>
					<!-- /wp:group -->
				</div>
				<!-- /wp:group -->
